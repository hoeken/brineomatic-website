...
<a href="https://firmware.brineomatic.com"><img src="/assets/provisioning.png" alt="Provisioning UI" class="img-right"></a>
...
1. Open your browser to [http://brineomatic.local](http://brineomatic.local)
